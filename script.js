      ...
      contactForm.reset();
        ...
        try {
            ...
            const zappyResponse = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'ab8e5fb4-de0b-455e-a322-1d3381a5fe84',
            ...
            console.log('✅ Zappy: Email sent successfully', zappyResult);
        } catch (zappyError) {
            console.error('❌ Zappy: Failed to send email', zappyError);
        }
        });
  }
});
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "MEETIX משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
